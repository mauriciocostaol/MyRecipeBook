...
namespace MyRecipeBook.Infrastructutre.Migrations.Versions
{
    ...
    public class Version0000002 : VersionBase
    {
        ...
        public override void Up()
        {
            ...
            CreateTable("Ingredients")
                ...
                .WithColumn("RecipeId").AsInt64().NotNullable().ForeignKey("FK_Ingrdient_Recipe_Id", RECIPE_TABLE_NAME, "Id")
