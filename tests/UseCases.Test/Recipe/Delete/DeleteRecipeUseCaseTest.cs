...
{
    [Fact]
    public async Task SuccessOnDeleteRecipe()
    {
    ...
    [Fact]
    public async Task ErrorOnDeleteRecipeWhenRecipeNotFound()
    {
        (var user, _) = UserBuilder.Build();
        ...
        MyRecipeBook.Domain.Entities.Recipe? recipe = null)
    {
        ...
        return new DeleteRecipeUseCase(loggedUser, repositoryWrite, repositoryRead, unitOfWork);
    }
}
