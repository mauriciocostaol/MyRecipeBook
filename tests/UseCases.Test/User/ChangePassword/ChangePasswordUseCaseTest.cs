...
public class ChangePasswordUseCaseTest
{
    ...
    public async Task ErrorWhenNewPasswordIsEmpty()
    {
        ...
        (await act.Should().ThrowAsync<ErrorOnValidationException>())
            .Where(e => e.ErrorMessages.Count == 1 && e.ErrorMessages.Contains(ResourceMessagesExceptions.PASSWORD_EMPTY));
    ...
    public async Task ErrorWhenCurrentPasswordIsDifferent()
    {
        ...
        (await act.Should().ThrowAsync<ErrorOnValidationException>())
            .Where(e => e.ErrorMessages.Count == 1 && e.ErrorMessages.Contains(ResourceMessagesExceptions.PASSWORD_DIFFERENT_CURRENT_PASSWORD));
