...
public class FilterRecipeTest : MyRecipeBookClassFixture
{
    ...
    [Fact]
    public async Task SuccessOnRequestToFilterRecipe()
    {
    ...
    [Fact]
    public async Task SuccessOnRequestToFilterRecipeWhenResultIsNoContent()
    {
    ...
    public async Task ErrorOnRequestTofilterRecipeWhenCookingTimeIsInvalid(string culture)
    {
        var request = RequestFilterRecipeJsonBuilder.Build();
