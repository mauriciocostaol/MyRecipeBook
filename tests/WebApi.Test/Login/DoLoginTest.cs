...
public class DoLoginTest : MyRecipeBookClassFixture
{
    ...
    [Fact]
    public async Task SuccessOnRequestToDoLogin()
    {
    ...
    public async Task ErrorOnRequestToDoLogin(string culture)
    {
        var request = RequestLoginJsonBuilder.Build();


        var response = await DoPost(method: METHOD,request: request,culture);
